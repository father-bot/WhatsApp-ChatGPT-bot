function Personality(name, prompt) {
    this.name = name
    this.prompt = prompt
}

const personalities = {
    generalAssistant: new Personality(
        'general assistant',
    ...
    startupIdeaGenerator: new Personality(
        'startup idea maker',
